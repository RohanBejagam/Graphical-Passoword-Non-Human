...
class TkinterCustomButton(tkinter.Frame):
    ...
    def __init__(self,
        ...
        # Calculate font size dynamically based on button height
        default_font_size = int(sqrt(self.height * self.width) / 8)
        self.text_font = (self.text_font[0], default_font_size) if text_font is None else text_font
    ...
    def draw(self):
        ...
        # use the given image
            ...
            self.image_label.place(relx=0.75,
                                   rely=0.5,
            ...
            self.text_label = tkinter.Label(master=self,
                                            ...
                                            bg=self.fg_color,
                                            fg=self.text_color)
            self.text_label.place(relx=0.25, rely=0.5, anchor=tkinter.CENTER)
